...
var AppBar = _react.default.forwardRef(function AppBar(props, ref) {
  ...
  return _react.default.createElement(_Paper.default, (0, _extends2.default)({
    ...
    component: "header",
    elevation: 4,
    className: (0, _clsx.default)(classes.root, classes["position".concat((0, _capitalize.default)(position))], classes["color".concat((0, _capitalize.default)(color))], className, {
      fixed: 'mui-fixed'
    }[position]),
    ref: ref
  }, other));
